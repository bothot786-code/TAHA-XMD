...
if (settings.numberList.length > 0) {
    ...
    console.log(`🔍 AREACT | group: ${isGroup} | participant: ${participant} | participantAlt: ${message.key.participantAlt} | result: ${listResult}`);
}
    ...
    try {
        ...
        if (!action) {
            ...
            await sock.sendMessage(chatId, {
                text: `🎭 *AUTO-REACT SETTINGS*\n\n` +
                      ...
                      `━━━━━━━━━━━━━━━━━━━━\n` +
                      `💡 *Examples:*\n` +
                      `└ .areact include add 9234747471404\n` +
                      `└ .areact include add 9234747471404,923474771404\n` +
                      `└ .areact exclude add 923474771404\n\n` +
        ...
        if (action === 'on') {
            ...
            if (sub === 'add') {
                ...
                if (numbers.length === 0) {
                    await sock.sendMessage(chatId, {
                        text: `⚠️ *USAGE*\n\n━━━━━━━━━━━━━━━━━━━━\n📖 .areact include add <numbers>\n\n✨ *Single:* .areact include add 923474771404\n✨ *Bulk:* .areact include add 923474771404,923291489055\n\n⚠️ Full number with country code is required`,
                        ...channelInfo
                    });
                    return;
                }
