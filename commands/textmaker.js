...
async function textmakerCommand(sock, chatId, message, q, type) {
    try {
        ...
        switch (type) {
            case 'metallic':
                 usageErrorText = "Example: .metallic Taha khan";
                break              
            case 'ice':
                usageErrorText = "Example: .ice taha khan";
                break;
            case 'snow':
                usageErrorText = "Example: .snow Taha khan";
                break;
            case 'impressive':
                usageErrorText = "Example: .impressive Taha";
                break;
            case 'matrix':
                usageErrorText = "Example: .matrix Taha";
                break;
            case 'light':
                usageErrorText = "Example: .light TAHA KHAN";
                break;
            case 'neon':
                usageErrorText = "Example: .neon Taha khan";
                break;
            case 'devil':
                usageErrorText = "Example: .devil Taha KHAN";
                break;
            case 'purple':
                usageErrorText = "Example: .purple Taha khan";
                break;
            case 'thunder':
                usageErrorText = "Example: .thunder Taha khan";
                break;
            case 'leaves':
                usageErrorText = "Example: .leaves Taha khan";
                break;
            case '1917':
                usageErrorText = "Example: .1917 taha khan";
                break;
            case 'arena':
                usageErrorText = "Example: .arena Taha khan";
                break;
            case 'hacker':
                usageErrorText = "Example: .hacker Taha khan";
                break;
            case 'sand':
                usageErrorText = "Example: .sand Taha khan";
                break;
            case 'blackpink':
                usageErrorText = "Example: .blackpink Taha khan";
                break;
            case 'glitch':
                usageErrorText = "Example: .glitch Taha khan";
                break;
            case 'fire':
                usageErrorText = "Example: .fire Taha khan";
                break;
            default:
